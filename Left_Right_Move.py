...
#setting
cd_leftmove = datetime.now().timestamp()
cd_rightmove = datetime.now().timestamp()
  ...
  while cap.isOpened():
    ...
    if results.multi_hand_landmarks:
      for hand_landmarks in results.multi_hand_landmarks:
        ...
        finger_center = statistics.mean(finger_tips);
        if finger_center_temp == 0:
            finger_center_temp = statistics.mean(finger_tips)
        ...
        moveMouse(varitation,direction,x)
        #if(finger_center - finger_center_temp > 20):
         #   print("Left!"+str(varitation))

        #if(finger_center - finger_center_temp < -20):
         #   print("Right!"+str(varitation))
        #print(finger_center,finger_center_temp)
        
        
        
        
        
        finger_center_temp = statistics.mean(finger_tips); #計算平均數
